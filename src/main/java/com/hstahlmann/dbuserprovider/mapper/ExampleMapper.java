package com.hstahlmann.dbuserprovider.mapper;
...
/*
 * Example protocol mapper.
 */
public class ExampleMapper extends AbstractOIDCProtocolMapper implements OIDCAccessTokenMapper, OIDCIDTokenMapper, UserInfoTokenMapper {
     ...
     */
    public static final String PROVIDER_ID = "oidc-example-mapper";
    ...
    static {
        ...
        OIDCAttributeMapperHelper.addIncludeInTokensConfig(configProperties, ExampleMapper.class);
    }
    ...
    public String getDisplayType() {
        return "Example Mapper";
    }

    @Override
    public String getHelpText() {
        return "Adds an example text to the claim";
    }
    ...
    protected void setClaim(final IDToken token, final ProtocolMapperModel mappingModel, final UserSessionModel userSession, final KeycloakSession keycloakSession, final ClientSessionContext clientSessionCtx) {
        ...
        //
        // Sets a static example string, but we could write a dynamic value like a group attribute here too.
        OIDCAttributeMapperHelper.mapClaim(token, mappingModel, "just an example");
    }
